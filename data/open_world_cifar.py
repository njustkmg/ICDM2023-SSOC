...
class OPENWORLDCIFAR100(torchvision.datasets.CIFAR100):
    ...
    def __init__(self, root, labeled=True, labeled_num=50, labeled_ratio=0.5, rand_number=0,
                 transform=None, target_transform=None, download=False, unlabeled_idxs=None):
...
class OPENWORLDCIFAR10(torchvision.datasets.CIFAR10):
    ...
    def __init__(self, root, labeled=True, labeled_num=5, labeled_ratio=0.5, rand_number=0,
                 transform=None, target_transform=None, download=False, unlabeled_idxs=None):
